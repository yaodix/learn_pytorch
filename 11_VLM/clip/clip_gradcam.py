...
image_caption = 'the traffic sign' #@param {type:"string"}
#@markdown ---
...
image_path = '/media/disk/yao/workspace/learn_pytorch/11_VLM/clip/workspace/testfile/expressway.jpg'
