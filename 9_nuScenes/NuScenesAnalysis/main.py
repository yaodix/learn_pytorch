...
def traverse_images(nusc, model_output=None, proj_lidar=False, visible_level=2, save_dir=None):
...
if __name__ == '__main__':
    ...
    data_root = '/media/yao/新加卷7/data/nuscenes/mini'
    nusc = NuScenes(version='v1.0-mini',
                    dataroot=data_root,
                    verbose=True)
    traverse_images(nusc, model_output=None, proj_lidar=True, visible_level=1, save_dir=None)
